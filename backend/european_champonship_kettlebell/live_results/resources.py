...
class PlayerResource(resources.ModelResource):
    ...
    class Meta:
        ...
        fields = (
            'id', 'name', 'surname', 'weight', 'club', 'categories', 'tiebreak',
            # Dodaj pola wejściowe wyników, jeśli chcesz je importować/eksportować
            'snatch_kettlebell_weight', 'snatch_repetitions',
            'tgu_weight_1', 'tgu_weight_2', 'tgu_weight_3',
            ...
            'pistol_squat_weight_1', 'pistol_squat_weight_2', 'pistol_squat_weight_3',
        )
