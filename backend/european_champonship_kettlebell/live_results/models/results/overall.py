...
class OverallResult(models.Model):
    ...
    total_points = models.FloatField(
        _("Suma punktów"), null=True, blank=True, db_index=True
    )
    ...
    def calculate_total_points(self) -> None:
        ...
        fields_to_sum = [
            ...
            self.kb_squat_points, self.pistol_squat_points,
            self.one_kb_press_points, self.two_kb_press_points,
        ...
        self.total_points = round(total, 1) if total != 0.0 or self.tiebreak_points != 0.0 else 0.0 # Można też dać None
