...
class BestSeeSawPressResult(models.Model):
    ...
    def update_best_result(self) -> bool:
        ...
        try:
            ...
            updated = False
            new_best_left = max(ssp_result.result_left_1 or 0.0, ssp_result.result_left_2 or 0.0, ssp_result.result_left_3 or 0.0)
            new_best_right = max(ssp_result.result_right_1 or 0.0, ssp_result.result_right_2 or 0.0, ssp_result.result_right_3 or 0.0)
