...
if TYPE_CHECKING:
    ...
    from .results.pistol_squat import PistolSquatResult # Usunięto BestPistolSquatResult
    ...
    from .results.two_kettlebell_press import TwoKettlebellPressResult, BestTwoKettlebellPressResult
...
class Player(models.Model):
    ...
    def update_related_results(self) -> None:
        ...
        try:
            from .results.kb_squat import KBSquatResult, BestKBSquatResult
            from .results.one_kettlebell_press import OneKettlebellPressResult
            from .results.pistol_squat import PistolSquatResult # Usunięto Best...
            from .results.see_saw_press import SeeSawPressResult, BestSeeSawPressResult
            from .results.snatch import SnatchResult, BestSnatchResult
            from .results.tgu import TGUResult
            from .results.two_kettlebell_press import TwoKettlebellPressResult, BestTwoKettlebellPressResult
            ...
            # Usunięto blok aktualizacji BestPistolSquatResult:
            # best_pistol_obj, _ = BestPistolSquatResult.objects.get_or_create(player=self)
            # best_pistol_obj.update_best_result()

            # --- See Saw Press ---
            SeeSawPressResult.objects.update_or_create(
                player=self,
                defaults={
                    "result_left_1": self.see_saw_press_weight_left_1 or 0.0, "result_right_1": self.see_saw_press_weight_right_1 or 0.0,
                    "result_left_2": self.see_saw_press_weight_left_2 or 0.0, "result_right_2": self.see_saw_press_weight_right_2 or 0.0,
                    "result_left_3": self.see_saw_press_weight_left_3 or 0.0, "result_right_3": self.see_saw_press_weight_right_3 or 0.0,
                },
            )
            best_ssp_obj, _ = BestSeeSawPressResult.objects.get_or_create(player=self)
            best_ssp_obj.update_best_result()

            # --- KB Squat ---
            KBSquatResult.objects.update_or_create(
                player=self,
                defaults={
                    "result_left_1": self.kb_squat_weight_left_1 or 0.0, "result_right_1": self.kb_squat_weight_right_1 or 0.0,
                    "result_left_2": self.kb_squat_weight_left_2 or 0.0, "result_right_2": self.kb_squat_weight_right_2 or 0.0,
                    "result_left_3": self.kb_squat_weight_left_3 or 0.0, "result_right_3": self.kb_squat_weight_right_3 or 0.0,
                },
            )
            best_kbs_obj, _ = BestKBSquatResult.objects.get_or_create(player=self)
            best_kbs_obj.update_best_result()
            ...
            TwoKettlebellPressResult.objects.update_or_create(
                player=self,
                defaults={
                    "result_left_1": self.two_kb_press_weight_left_1 or 0.0, "result_right_1": self.two_kb_press_weight_right_1 or 0.0,
                    "result_left_2": self.two_kb_press_weight_left_2 or 0.0, "result_right_2": self.two_kb_press_weight_right_2 or 0.0,
                    "result_left_3": self.two_kb_press_weight_left_3 or 0.0, "result_right_3": self.two_kb_press_weight_right_3 or 0.0,
                },
            )
            best_tkbp_obj, _ = BestTwoKettlebellPressResult.objects.get_or_create(player=self)
            best_tkbp_obj.update_best_result()
